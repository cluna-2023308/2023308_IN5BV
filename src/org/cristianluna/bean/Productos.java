...
public class Productos {
    ...
    */
    ...
    public Productos(int codigoProducto, String descripcion, double precioUnitario, double precioDocena, double precioMayor, String imagenProducto, int existencia, int codigoTipoProducto, int codigoProveedor) {
